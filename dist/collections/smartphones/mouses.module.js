...
MousesModule = __decorate([
    common_1.Module({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Mouse', schema: smartphone_schema_1.MouseSchema }])],
        controllers: [smartphones_1.MousesController],
        providers: [smartphones_service_1.MousesService],
    })
], MousesModule);
exports.MousesModule = MousesModule;
//# sourceMappingURL=mouses.module.js.map
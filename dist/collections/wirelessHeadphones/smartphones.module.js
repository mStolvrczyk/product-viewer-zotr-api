...
SmartphonesModule = __decorate([
    common_1.Module({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Smartphone', schema: wirelessHeadphones_schema_1.SmartphoneSchema }])],
        controllers: [wirelessHeadphones_1.SmartphonesController],
        providers: [wirelessHeadphones_service_1.SmartphonesService],
    })
], SmartphonesModule);
